...
- poll out of the way time for a history lesson
```
...
imagine your REST API is a vending machine and each piece of data is
one item on there you have to select individually and collect.
