...
<StyledList>
  <StyledListItem>REST API</StyledListItem>
...
<ul style={{ listStyle: 'none' }}>
  <li style={{ fontWeight: 'bold' }}>GraphQL API</li>
  <li>One Endpoint Only (POST /graphql)</li>
  <li>JSON Data is Exchanged</li>
  <li>Any Server-side Language, any frontend framework</li>
  <li>Stateless</li>
</ul>
