...
<Head>
  ...
  />
  <link
    href={require('file-loader!./static/favicon.png?v=1')}
    rel="shortcut icon"
  />
</Head>
...
###### [https://www.thinkwithgoogle.com/marketing-resources/data-measurement/mobile-page-speed-new-industry-benchmarks/](https://www.thinkwithgoogle.com/marketing-resources/data-measurement/mobile-page-speed-new-industry-benchmarks/)

```notes
- this slide is from a

- think with Google post, on mobile industry benchmarks (from 2018)
...
## [ss10.dev/GatsbyEatsAPIs](https://ss10.dev/gatsbyeatsapis)
...
<img
  ...
  src={require('file-loader!./images/mug-face.jpg')}
  alt="scott face"
/>
